 ...
 * =============================================================================
 */
/// <amd-module name="@ohos/tfjs-core/dist/ops/browser" />
 ...
 * @doc {heading: 'Browser', namespace: 'browser', ignoreCI: true}
 */
export declare function fromPixelsAsync(pixels: PixelData | ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | ImageBitmap, numChannels?: number): Promise<Tensor<import("@ohos/tfjs-core/dist/types").Rank.R3>>;
/**
